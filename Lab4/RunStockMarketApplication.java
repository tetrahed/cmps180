    ...
    public static void main(String[] args)
    {
    	...
    	try
        {
            ...
            connection = DriverManager.getConnection(
                                                     "jdbc:postgresql://cmps180-db.lt.ucsc.edu/rochung",
                                                     "rochung",
                                                     "instance49append");
            ...
            StockMarketApplication Application1 = new StockMarketApplication(connection); //constructor that calls StockMarketApplication

            //testing the functions
            Application1.getCustomersWhoSoldManyStocks(3);
            int affectedRows = Application1.updateQuotesForBrexit("LSE"); //need to figure out what this does
